...
const mapStateToProps = (state) => ({
  ...
  class FashionComp extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            indx: 0,
         ...
         <div className="row mt-5 mb-2">
            <div className="col-md-6 col-sm-12 col-xm-12">
                <div className="justify-content-center d-flex bg-color-f6f6f4 relative">
                  <FashionCarousel proplibraryImages= {this.state.firstProductImages} />
                </div>
            </div>
            <div className="col-md-6 col-sm-12 col-xm-12">
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(FashionComp);
